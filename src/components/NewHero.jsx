  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ background: 'linear-gradient(165deg, #0B0E1E 0%, #15192C 50%, #0B0E1E 100%)' }}>
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 right-1/4 w-[500px] h-[500px] rounded-full bg-blue-600/[0.04] blur-[150px]" />
      ...
      <div className="relative container mx-auto px-6 lg:px-8 py-10 sm:py-16 lg:py-28 xl:py-32">
        <div className="flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-16 xl:gap-20">
          ...
          <div className="hidden lg:flex gap-5 shrink-0">
            ...
            <GlassCard delay={0.5} className="p-5 w-[220px] xl:w-[260px] self-start">
              <span className="text-white font-semibold text-sm mb-4 block">Popular</span>
              <div className="space-y-3.5">
                {popularAssets.map((asset) => (
                  <div key={asset.symbol} className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <img src={asset.icon} alt={asset.symbol} className="w-6 h-6 rounded-full shrink-0" />
              ...
              <Link to="/assets" className="mt-5 text-[#94A3B8] text-xs hover:text-[#2563EB] transition-colors inline-flex items-center gap-1">
